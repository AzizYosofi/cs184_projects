...
static enum {view, translate, scale, lightop} transop ; // which operation to transform
...
/* Variables used for light movement */
static int activeLight;
static int upDir = 0;
static int leftDir = 1;
EXTERN GLfloat lightposnReset [4*numLights] ; // Original Light Positions

/* Variables for single object movement */
static GLfloat shininessBackup;
static GLfloat diffuseBackup[4];
static bool transformingObj;
static int objIndex;
